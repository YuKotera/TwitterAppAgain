...
//  TwitterAppAgain
//
//  Created by yukotera on 2015/09/19.
...
class TimeLineTableViewController: UITableViewController {
    ...
    let dataArray:[[String:String]] = [
        [  "title" : "タイトル1",
           "image" :"https://pbs.twimg.com/profile_images/378800000220029324/fe66faeca20115da8566e51d83447ead.jpeg"
        ],
        [   "title": "タイトル2",
            "image": "https://pbs.twimg.com/profile_images/496137097007218688/B5XJEdE2.jpeg"
        ]
    ]
    ...
    @IBAction func taTweetpButton(sender: UIBarButtonItem) {
